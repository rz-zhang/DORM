...
def main(cfg) -> None:
    ...
    print("=" * 50)
    print(f"Data config:")
    print(f"- data_prefix: {cfg.model.data.data_prefix}")
    print(f"- data_impl: {cfg.model.data.data_impl}")
    print(f"- splits_string: {cfg.model.data.splits_string}")
    ...
    print("\nModel info:")
    print(f"- Model type: {type(ptl_model)}")
    print("=" * 50)
