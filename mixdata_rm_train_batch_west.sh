...
python ./examples/nlp/gpt/train_reward_model.py \
      ...
      exp_manager.explicit_log_dir=/fsx-Training/home/ronzhi/west_results_model/1119_west_2a_1node_oh_100k_2epoch_lr3e6 \
      trainer.rm.save_interval=800 \
      trainer.rm.val_check_interval=800 \
      exp_manager.create_wandb_logger=True \
      exp_manager.wandb_logger_kwargs.project=batch_rm \
      exp_manager.wandb_logger_kwargs.name=1115_west_2a_1node_oh_100k_2epoch_lr3e6 \
