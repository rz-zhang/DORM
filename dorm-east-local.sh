...
python ./examples/nlp/gpt/train_reward_model.py \
      ...
      exp_manager.explicit_log_dir=/fsx-Training/home/ronzhi/neoteam_west_results_model/1114_1node_dorm_mix_80k_12label_2epoch_lr3e6 \
      trainer.rm.save_interval=300 \
      trainer.rm.val_check_interval=300 \
      exp_manager.create_wandb_logger=True \
      exp_manager.wandb_logger_kwargs.project=dorm \
      exp_manager.wandb_logger_kwargs.name=neoteam_1114_1node_dorm_mix_80k_12label_2epoch_lr3e6 \
